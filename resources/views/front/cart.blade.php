                ...
                @foreach ($cart->get() as $item)
                    <div class="cart-single-list" id="{{$item->id}}">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-1 col-md-2 col-12">
                                <a class="remove-item" data-id="{{ $item->id }}" href="javascript:void(0)"><i class="lni lni-close"></i></a>                            </div>
                        </div>
                    </div>
                @endforeach
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="right">
                                    ...
                                    <div class="button">
                                        <a href="https://demo.graygrids.com/themes/shopgrids/checkout.html"
