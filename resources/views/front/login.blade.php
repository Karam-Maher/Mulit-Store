                ...
                <form class="card login-form" method="post">
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap justify-content-between bottom-content">
                            ...
                            <a class="lost-pass" href="https://demo.graygrids.com/themes/shopgrids/account-password-recovery.html">Forgot
                                password?</a>
                        </div>
                        <div class="button">
                            <button class="btn" type="submit">Login</button>
                        </div>
                        <p class="outer-link">Don't have an account? <a href="https://demo.graygrids.com/themes/shopgrids/register.html">Register here </a>
                        </p>
                    </div>
                </form>
            </div>
